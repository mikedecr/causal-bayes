...
The original figure of results (from $t$-tests) is shown in Figure&nbsp;\@ref(fig:original-reeves). Treatment effects were all positive, but because most of the one-off effects were statistically insignificant, the authors initially conclude that information about policy instruments or prerogatives has minimal effects. Their interpretation of the effects veers in an informally Bayesian direction when they note the similarity of the effects overall: 
